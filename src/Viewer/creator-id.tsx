...
export const CreatorID = () => {
    ...
    return (
        <div className=''>
            ...
            <div className="flex items-center justify-between p-4 relative z-20">
                ...
                <div className='flex space-x-3 items-center'>
                    <div className="relative">
                        <input type="text" placeholder="Search..." className="pl-10 pr-4 py-2 border rounded-lg shadow-sm outline-none  focus:ring-black" />
                ...
                <button className="ml-2 px-4 py-2 bg-black text-white rounded-lg shadow-sm hover:bg-white hover:text-black border border-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
            ...
            <p className='text-center text-sm my-2'>about this creator who loves creating what you love</p>
